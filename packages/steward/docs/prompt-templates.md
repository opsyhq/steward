...
Steward scopes prompt templates to each agent. It loads them from:

- The agent's home: `~/.steward/agents/<name>/prompts/*.md`
- Project-local (under the agent's home): `.steward/prompts/*.md`
