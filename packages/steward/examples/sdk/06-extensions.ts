...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@opsyhq/steward";
...
export default function (steward: ExtensionAPI) {
	...
	steward.on("agent_end", async (event) => {
	...
	// Register a command
	steward.registerCommand("mycommand", {
