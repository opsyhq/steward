 ...
 *
 * Usage: steward --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@opsyhq/steward";
...
export default function (steward: ExtensionAPI) {
	...
	steward.registerCommand("overlay-animation", {
	...
	steward.registerCommand("overlay-anchors", {
	...
	steward.registerCommand("overlay-margins", {
	...
	steward.registerCommand("overlay-stack", {
	...
	steward.registerCommand("overlay-overflow", {
	...
	steward.registerCommand("overlay-edge", {
	...
	steward.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	steward.registerCommand("overlay-maxheight", {
	...
	steward.registerCommand("overlay-sidepanel", {
	...
	steward.registerCommand("overlay-toggle", {
	...
	steward.registerCommand("overlay-passive", {
	...
	steward.registerCommand("overlay-focus", {
	...
	steward.registerCommand("overlay-streaming", {
