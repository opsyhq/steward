...
import type { ExtensionAPI, ExtensionCommandContext } from "@opsyhq/steward";
import { DynamicBorder, getMarkdownTheme } from "@opsyhq/steward";
...
export default function (steward: ExtensionAPI) {
	steward.registerCommand("summarize", {
