...
Play DOOM as an overlay in Steward. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
steward --extension ./examples/extensions/doom-overlay
```
...
- [steward-doom](https://github.com/badlogic/pi-doom) for the original Steward integration
