...
export class ExtensionRunner {
	...
	invalidate(
		message = "This extension handle is stale after session replacement or reload. Do not use a captured voli or conversation after conversation.newSession() or conversation.reload(). For newSession, move post-replacement work into withConversation and use the conversation passed to it.",
	): void {
