...
/** Pick a backend from the platform, honoring the `VOLI_SERVICE_MANAGER` override. */
 ...
 * Resolved from `process.execPath` + `process.argv[1]` — both point at the running `voli` CLI
