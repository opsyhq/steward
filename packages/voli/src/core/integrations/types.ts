 ...
 *    one genuinely new concept (voli is otherwise pull/request-response).
 *
 ...
 * scoped to one service. Backed by `~/.voli/agents/<name>/store/<service>.json`,
...
/** The definition an integration factory registers via `voli.registerIntegration`. */
