 ...
 * shared `~/.voli/agent/settings.json` holds the defaults; each agent's `settings`
...
/**
 * The shared defaults + per-agent override surface. Pruned to the set voli/apps
...
// =============================================================================
// Shared defaults reader (~/.voli/agent/settings.json)
// =============================================================================
//
...
/** The shared defaults from `~/.voli/agent/settings.json` (process-cached). */
...
/** The shared default provider, read from `~/.voli/agent/settings.json`. */
export function getDefaultProvider(): string | undefined {
	return loadSharedDefaults().defaultProvider;
}

/** The shared default model id, read from `~/.voli/agent/settings.json`. */
export function getDefaultModel(): string | undefined {
	return loadSharedDefaults().defaultModel;
}

/** The shared default model scope, read from `~/.voli/agent/settings.json`. */
export function getEnabledModels(): string[] | undefined {
	return loadSharedDefaults().enabledModels;
}

/** The shared default thinking level, read from `~/.voli/agent/settings.json`. */
export function getDefaultThinkingLevel(): ThinkingLevelSetting | undefined {
	return loadSharedDefaults().defaultThinkingLevel;
}

/**
 * Read-modify-write the shared defaults file (`~/.voli/agent/settings.json`), then drop the cache
...
export class AgentSettingsManager {
	...
	getShowHardwareCursor(): boolean {
		return this.merged.showHardwareCursor ?? process.env.VOLI_HARDWARE_CURSOR === "1";
	}
	...
	getClearOnShrink(): boolean {
		...
		return process.env.VOLI_CLEAR_ON_SHRINK === "1";
	}
