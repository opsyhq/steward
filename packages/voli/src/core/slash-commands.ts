...
/**
 * voli's built-in interactive slash commands — the ones `InteractiveMode.handleSubmit`
...
/**
 * voli's dashboard (home screen) slash commands — the ones `DashboardView.runCommand`
