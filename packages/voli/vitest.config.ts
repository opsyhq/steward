...
// `getMarkdownTheme` from "@opsyhq/voli") resolves without a built dist/.
const voliSrc = fileURLToPath(new URL("./src/index.ts", import.meta.url));
...
export default defineConfig({
	...
	resolve: {
		...
		alias: [
			...
			{ find: /^@opsyhq\/voli$/, replacement: voliSrc },
		],
	},
});
