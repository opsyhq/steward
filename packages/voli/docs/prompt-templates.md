...
Voli scopes prompt templates to each agent. It loads them from:

- The agent's home: `~/.voli/agents/<name>/prompts/*.md`
- Project-local (under the agent's home): `.voli/prompts/*.md`
